select * from bike where type_bike = 'urban';

select * from custom where surname = 'Rodriguez';

select * from bike where price between 100 and 400;

select * from store where name_store = 'NANO bicycles' and stars = 5;
